...
{'nombre' : 'Churros',
'ingredientes1' : '250 g. harina de trigo todo uso (también se puede hacer con harina de panadería)<br>250 g. de agua<br>1 cucharadita de sal (8 gramos aproximadamente)<br>Azúcar para espolvorear',
'ingredientes2' : 'Aceite de oliva suave para freír o aceite de girasol<br>Papel absorbente de cocina<br>Una churrera manual o una manga pastelera con boca fina.',
...
{'nombre' : 'Gorditas',
'ingredientes1' : '1/2 cebollas, finamente picada<br>1 taza de chicharrón, prensado<br>1/2 kilos de masa de maíz<br>2 tazas de manteca de cerdo, para freír<br>1/2 tazas de queso fresco, desmoronado',
'ingredientes2' : '1/2 tazas de cebolla, finamente picada, para servir<br>1/2 tazas de cilantro fresco, finamente picado, para servir<br>al gusto de salsa verde, para acompañar',
'preparacion' :'Calienta una sartén a fuego medio agrega la cebolla blanca y cocina hasta que se suavice, añade el chicharrón prensado y cocina 10 minutos. Enfría y reserva.<br>Forma bolitas de masa, haz un orificio en el centro y rellena con el chicharrón. Aplana la masa para hacer la gordita, forma un círculo de 8 cm de diámetro.<br>Calienta una ollita con la manteca, fríe las gorditas hasta que doren. Retira las gorditas y escurre sobre papel absorbente.<br>Corta la gordita por la mitad rellena con queso, la cebolla y cilantro. Sirve con salsita. Disfruta.',
'img' : '../../../../assets/imagenes/Comida-Mexicana/gorditas.jpg',
'pais' : 'mexicanas'},

{'nombre' : 'Mole',
'ingredientes1' : '15 chiles anchos<br>12 chiles mulatos y 12 chiles pasilla 6 chiles chipotles o morita 1/2  cebolla 1 cabeza de ajo 2 jitomates /n anís 2 o 3 rajitas de canela150 gr de uva pasa<br>100 gr de pepita de calabaza peladas<br>50 gr de almendras<br>100 gr de cacahuate<br>3 clavos (o la punta de una cucharita)<br>1 piloncillo<br>2 tortillas<br>1 pieza de Chocolate Abuelita<br>2 cucharas soperas de manteca de cerdo',
'ingredientes2' : '1 plátano macho<br>Piezas de guajolote o pollo<br>1 pza mediana de pan blanco<br>Semillas de cilantro<br>1 litro de caldo de pollo.',
...
{'nombre' : 'Caldo de res',
'ingredientes1' : '12 tazas de agua<br>2 lbs de trozos de res con hueso<br>1 cabeza de ajo<br>2 hojas de laurel<br>2 a 3 cucharadas de sal<br>4 papas blancas cortadas en cubos de una pulgada<br>3 chiles serranos cortados en trozos<br>1 cebolla blanca pequeña cortada en cubos<br>4 zanahorias cortadas gruesas',
'ingredientes2' : '3 elotes cortados en 9 trozos<br>4 tazas de repollo verde cortado en trozos de una pulgada (green cabbage)<br>½ taza de cilantro picado<br>16 tortillas de maíz, si las deseas<br>1 lima grande cortada en gajos, si la deseas',
'preparacion' :'En una olla grande y pesada, vierte las 10 tazas de agua, la carne de res, el ajo, las hojas de laurel y 1 1/2 cucharada de sal. Cocina hasta hervir, retirando la espuma de la parte superior, si es necesario. Tapa la olla, baja el fuego y continúa cocinando entre 1 1/2 hora y 2 horas o hasta que la carne esté blanda.<br>En la licuadora, agrega los chiles serranos, 1/2 cucharadita de sal y 1/4 taza de agua, licúa hasta que esté todo bien mezclado y reserva.<br>Una vez que la carne esté blanda, retira las hojas de laurel y la cabeza de ajo. Agrega las papas en la olla, además de las cebollas, las zanahorias y los elotes. Añade las 2 tazas de agua restantes, prueba el caldo para determinar si tiene suficiente sal y condimenta a gusto. Deja que hierva, luego baja el fuego y continúa cocinando hasta que las papas estén tiernas cuando las pruebes con un tenedor.<br>Cuando las papas estén tiernas, retira los elotes y la carne de la sopa, transfiere a un recipiente grande y tapa para mantener todo caiente.<br>Agrega el repollo (green cabagge) y 1/4 taza de cilantro a la sopa. Cocina durante otros 15 a 20 minutos, hasta que el repollo (col verde) esté tierno pero al dente. Retira la sopa del fuego y déjala reposar durante 15 minutos. Calienta las tortillas de maíz en un comal o sartén caliente y mantenlas tibias en un calentador de tortillas.<br>6 Divide la sopa en 8 recipientes. Agrega el elote y un trozo de carne a cada recipiente. Decora con los gajos de lima, el cilantro y la salsa Serrano para agregar un toque picante.<br>7 Puedes servir con tortillas de maíz tibias, si lo deseas.',
'img' : '../../../../assets/imagenes/Comida-Mexicana/Sin título-4.jpg',
'pais' : 'mexicanas'},

{'nombre' : 'Tacos al pastor',
'ingredientes1' : '2 chiles anchos, desvenados e hidratados<br>2 chiles guajillos, desvenados e hidratados<br>1/2 barras de pasta de achiote<br>1/4 tazas de vinagre blanco<br>1/2 tazas de jugo de naranja, agria<br>4 cucharadas de aceite de maíz<br>1 taza de cebolla, picada finamente',
'ingredientes2' : '1 taza de cilantro fresco, picado<br>1 kilo de filete de cerdo, en bisteces, salpimentados<br>1/2 cebollas, fileteada<br>6 limones, partidos en cuartos<br>2 tazas de salsa picante, a su elección<br>1 taza de piña, natural asada y picada en trocitos',
'preparacion' :'Licúa los chiles, el achiote, el vinagre, el jugo de naranja y reservar.<br>Unta la carne con la mezcla de achiote y cubre con el resto de la mezcla. Deja marinar 2 horas.<br>En una sartén bien caliente saltear con un poco de aceite la cebolla fileteada. Agrega la carne marinada hasta que este bien doradita.<br>Pica la carne ya cocinada para formar los tacos.<br>Acompaña con cebolla, cilantro, limón, piña y salsita.<br>','img' : '../../../../assets/imagenes/Comida-Mexicana/tacos.jpg',
'pais' : 'mexicanas'},
